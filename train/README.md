...
| `train_baseline.py` | 3a. baseline | single-stage SGD fine-tune (the ablation reference) | Kaggle T4 ×2 |
| `train_staged/` | 3b. final | three-stage (A/B/C) AdamW training with custom long-tail class weights on stages B/C (injection mechanism: [`docs/TRAINING.md`](../docs/TRAINING.md) §5) | Kaggle T4 ×2 |
